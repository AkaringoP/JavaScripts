...
(function () {
  ...
  async function main() {
    ...
    if (!context.isValidProfile()) {
      console.log(
        '[Danbooru Grass] Not a valid profile page or extraction failed.'
      );
      return;
    }
    ...
    const updateView = async () => {
      ...
      try {
        // Initial render for layout (header updates here slightly prematurely)
        // We pass the callback even here so the dropdown works during loading
