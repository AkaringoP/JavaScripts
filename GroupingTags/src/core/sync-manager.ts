...
export class SyncManager {
     ...
     */
    static async syncShard(shardIndex: number, localShardData: Record<string, PostTagData>, silent = false) {
        ...
        const compressedPayload = LZString.compressToUTF16(JSON.stringify(mergedData));
