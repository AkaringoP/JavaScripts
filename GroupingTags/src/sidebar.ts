...
export class SidebarInjector {
    ...
    private injectIndicators(groups: { [key: string]: string[] }) {
        ...
        const currentSelect = document.querySelector('.grouping-tags-view-switch select') as HTMLSelectElement;
    ...
    private renderGroupView(groups: { [key: string]: string[] }) {
        ...
        const moveOrCloneLi = (tag: string, targetUl: HTMLElement, groupNames: string[]) => {
            ...
            const originalLi = document.querySelector(`li[data-tag-name="${CSS.escape(tag)}"]`) as HTMLElement;
