...
| :--- | :--- | :--- |
| **[Danbooru Insights](./DanbooruInsights)** | Injects a GitHub-style contribution graph and advanced analytics dashboard into Danbooru profile pages. | [Install](https://github.com/AkaringoP/JavaScripts/raw/main/DanbooruInsights/DanbooruInsights.user.js) |
...
| **[Danbooru Grouping Tags](./GroupingTags)** | Advanced tag management system featuring visual grouping, character-first sorting, and Gist synchronization. | [Install](https://github.com/AkaringoP/JavaScripts/raw/main/GroupingTags/dist/groupingtags.user.js) |
