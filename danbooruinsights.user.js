...
"appealed": "#bf3989"
       ...
       `;
        ...
        const updateTabs = () => {
          ...
          const gsqeGroup = topPostContainer.querySelector("#top-post-tabs-gsqe");
          const sfwnsfwGroup = topPostContainer.querySelector("#top-post-tabs-sfwnsfw");
          if (currentWidgetMode === "most") {
            ...
            for (const mode of ["g", "s", "q", "e"]) {
              const btn = topPostContainer.querySelector(`button[data-mode="${mode}"]`);
